...
def error_message_detail(error, error_detail:sys):
    _,_,exc_tb = error_detail.exc_info() # returns 3 pieces of info
    file_name = exc_tb.tb_frame.f_code.co_filename # retrieve file name - custom exception handling in python documentation
